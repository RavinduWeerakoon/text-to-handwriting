  ...
  '#page-size': {
    ...
    action: (e) => {
      if (e.target.value =='a4') {
        pageEl.style.width = "598px"
        pageEl.style.height = `843px`;
        
      }else if(e.target.value =='envelope'){
        pageEl.style.width = "666px"
        pageEl.style.height = `288px`
      }else if(e.target.value =='notecard'){
